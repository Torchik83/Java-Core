...
class Phonebook {
    ...
    public void add(String surname, String number){
        if(book.containsKey(surname)){
            ...
            if(!numbers.contains(number)){
                ...
                System.out.println(String.format("Номер %s уже существует для данной фамилии %s", number, surname));
            }
        } else {
    ...
    public List<String> get(String surname){
        if(book.containsKey(surname)){
            ...
            System.out.println(String.format("В справочнике нет записи для данной фамилии %s", surname));
